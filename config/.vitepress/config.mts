...
export default defineConfig({
  ...
  themeConfig: {
        ...
        "items": [
          {
            ...
            "items": [
              ...
              { "text": "政治与国际关系学院", "link": "/zh/college/shss/spir/index" },
          ...
          },
          {
            ...
            "items": [
              ...
              { "text": "生物与生命科学学院", "link": "/zh/college/sns/sbls/index" },
          ...
          },
          {
            ...
            "items": [
              ...
              { "text": "材料科学与工程学院", "link": "/zh/college/set/smse/index" },
              { "text": "电气与电子工程学院", "link": "/zh/college/set/seee/index" },
              { "text": "信息与计算机学院", "link": "/zh/college/set/sice/index",
                items:[
                  { "text": "计算机科学与技术", "link": "/zh/college/set/sice/computer-sience/index"}
                ]
               },
              { "text": "航空航天学院", "link": "/zh/college/set/sae/index" },
              { "text": "环境与能源工程学院", "link": "/zh/college/set/seee2/index" }
            ]
          },
          {
            "text": "医药与健康科学学院",
            ...
            "items": [
              { "text": "基础医学与生命健康学院", "link": "/zh/college/smhs/sbmlh/index" },
              ...
              { "text": "健康与运动科学学院", "link": "/zh/college/smhs/shss/index" }
            ]
          },
          {
            "text": "农业与环境学院",
          ...
          },
          {
            ...
            "items": [
              ...
              { "text": "跨学科科学与工程学院", "link": "/zh/college/sief/sise/index" }
            ]
          },
          {
            "text": "艺术与设计学院",
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/HectorUnicorn/shanheuniverse.cn' }
    ]
  },
  locales: {
    root: {
